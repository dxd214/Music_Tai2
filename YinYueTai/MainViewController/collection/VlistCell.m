...
- (IBAction)buttonAction:(UIButton *)sender{
    ...
    switch (tag) {
        ...
        case 203:
        {
            PlayListDetailViewController *playList = [[PlayListDetailViewController alloc] init];
           
            playList.mvId  = [_model.vlistId stringValue];
            [self.viewController.navigationController pushViewController:playList animated:YES];
            [playList release];
